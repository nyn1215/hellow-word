<template>
  <div>
    <a-card :bordered="false" title="平台信息" :body-style="{ padding: '0' }">
      <div class="salesCard">
            ...
            <a-row :style="{ padding: '20px' }">
              <a-form :form="form" @submit="handleSubmit">
                ...
                >
                 ...
                 <!-- <a-form-item label="账号" :label-col="{ span: 3 }"
                  :wrapper-col="{ span: 10 }">
                    <a-input
                      disabled
                      v-decorator="['account', {rules: [{required: false, message: '请输入账号'}]}]"
                      placeholder="请输入账号"
                    />
                  </a-form-item>
                  <a-form-item label="密码" :label-col="{ span: 3 }"
                  :wrapper-col="{ span: 10 }">
                    <a-input
                      type="password"
              ...
              allowClear
              placeholder="请选择社区"
              v-decorator="[ 'communityIdNo', {rules: [{ required: false, message: '请选择社区' }]}]"
            >
              <a-select-option
